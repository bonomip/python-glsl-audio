from utils import round_up_to_even, np, math, get_smoothing_filter, numpy_data_buffer
...
class StreamAnalyzer:
    def __init__(self, stream_reader):
        ...
        ##FFT magic #2
        self.data_windows_to_buffer = math.ceil(self.FFT_window_size / self.stream_reader.chunk)
